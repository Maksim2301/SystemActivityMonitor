...
/**
 * ReportService з реалізацією вкладеної структури:
 * Report → DaySummary → HourStat + DeepReportIterator.
 */
public class ReportService {
    ...
    public Report generateReport(User user, String reportName, LocalDate startDate, LocalDate endDate) {
        ...
        // Отримуємо статистику системи та часи простою
        ...
        // Побудова вкладеної структури DaySummary → HourStat
    ...
    /** Детальний звіт CPU/RAM по годинах (через DeepReportIterator) */
