...
public class ReportRepositoryImpl implements ReportRepository {
    ...
    public void save(Report report) {
        ...
        (user_id, report_name, period_start, period_end, cpu_avg, ram_avg, 
         idle_time_total_seconds, app_usage_json, file_path, days_json, created_at)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        """;
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            String daysJson = gson.toJson(report.getDays()); // ✅ новий JSON для денних даних
            ...
            ps.setString(10, daysJson); // ✅ додаємо JSON днів
    ...
    public Optional<Report> findById(Integer id) {
        ...
        List<Report> result = executeQuery(sql, ps -> ps.setInt(1, id));
    ...
    private Report mapReport(ResultSet rs) throws SQLException {
        ...
        if (daysJson != null && !daysJson.isBlank()) {
            java.lang.reflect.Type type = new com.google.gson.reflect.TypeToken<List<DaySummary>>(){}.getType();
            r.setDays(gson.fromJson(daysJson, type));
        }
