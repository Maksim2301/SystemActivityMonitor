...
public class Report {
    ...
    private BigDecimal avgUptimeHours;          // ✅ ДОДАНО
    ...
    public BigDecimal getAvgUptimeHours() { return avgUptimeHours; }      // ✅ ДОДАНО
    public void setAvgUptimeHours(BigDecimal avgUptimeHours) {            // ✅ ДОДАНО
        this.avgUptimeHours = avgUptimeHours;
    }
